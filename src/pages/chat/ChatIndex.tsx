                    ...
                    <aside css={chatStyles.contacts}>
                        ...
                        {contacts.map((c) => (
                            <div
                                ...
                                style={{ background: selectedContact && selectedContact.id === c.id ? 'rgba(60,80,180,0.32)' : undefined }}
                            >
                    ...
                    <div style={{ display: 'flex', flex: 1, minWidth: 0 }}>
                        ...
                        >
                            {selectedContact ? (
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', color: '#bfc8db', fontSize: '1.2rem', opacity: 0.7 }}>
                        ...
                        {detailsOpen && selectedContact ? (
                            <aside css={chatStyles.details}>
                                <button css={chatStyles.closeBtn} onClick={() => { setDetailsOpen(false); setSelectedContact(null); }}>&times;</button>
